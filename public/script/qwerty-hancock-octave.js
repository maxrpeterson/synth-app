...
(function (window, undefined) {
    ...
    var init = function (us) {
        ...
        settings.currentOctave = settings.startOctave;
    ...
    */
    ...
    var getKeyPressed = function (keyCode) {
        return key_map[keyCode]
                .replace('l', parseInt(settings.currentOctave, 10) + settings.keyPressOffset)
                .replace('u', (parseInt(settings.currentOctave, 10) + settings.keyPressOffset + 1)
                .toString());
    };
    ...
    var octUp = function() {
        settings.currentOctave += 1;
        return settings.currentOctave;
    };
    ...
    var QwertyHancock = function (settings) {
        ...
        this.octaveUp = function(callback) {
            return octUp();
        };

        this.octaveDown = function(callback) {
            return octDown();
        };
